...
export function Sidebar(){
    ...
    return <div className=" min-h-[100vh-4rem] w-12 md:w-40 text-gray-600 pl-2 md:px-4 pt-4 fixed left-0 top-16">
            ...
            <div className="tweets flex gap-2 items-center gap-2r hover:bg-gray-200 hover:cursor-pointer w-full py-1 px-1 rounded">
                <TweetIcon size="md"/>
                <span className=" hidden text-sm md:block">Tweets</span>
            </div>

            <div className="videos flex gap-2 items-center hover:bg-gray-200 hover:cursor-pointer w-full py-1 px-1 rounded">
                <VideoIcon size="md"/>
                <span className=" hidden text-sm md:block">Videos</span>
            </div>

            <div className="documents flex gap-2 items-center hover:bg-gray-200 hover:cursor-pointer w-full py-1 px-1 rounded">
